...
<Segment inverted>
  ...
  <Form inverted>
    ...
    councillors.map((councillor) => {
      ...
      if((councillor.Party == userInput || councillor.Party.toLowerCase() == userInput || councillor.Party.toUpperCase() == userInput) && councillor.Council == "Mid Ulster"){
      return (
...
export default withAuthenticator(Ulster);

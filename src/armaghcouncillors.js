...
useEffect(() =>{
  ...
  return (
    <div className="Faq">
      ...
      <NavExample /> 
      <div>
      <h1>Councillors - Armagh City, Banbridge & Craigavon</h1>
      </div>
      <div className="Quiz">
        <br></br>
<div>
...
<Segment inverted>
  ...
  <Form inverted>
    ...
    councillors.map((councillor) => {
      ...
      if((councillor.Party == userInput || councillor.Party.toLowerCase() == userInput || councillor.Party.toUpperCase() == userInput) && councillor.Council == "Armagh City Banbridge and Craigavon"){
      return (
...
export default withAuthenticator(Armagh);

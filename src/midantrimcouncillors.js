...
useEffect(() =>{
  ...
  return (
    <div className="Faq">
      ...
      <NavExample /> 
      <div>
      <h1>Councillors - Mid & East Antrim</h1>
      </div>
      <div className="Quiz">
        <br></br>
<div>
...
<Segment inverted>
  ...
  <Form inverted>
    ...
    councillors.map((councillor) => {
      ...
      if((councillor.Party == userInput || councillor.Party.toLowerCase() == userInput || councillor.Party.toUpperCase() == userInput) && councillor.Council == "Mid and East Antrim"){
      return (
...
export default withAuthenticator(MidAntrim);

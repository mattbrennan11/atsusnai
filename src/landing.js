...
<div>
    ...
    <div className="Img">
      <img alt="map" src={require('./map.jpeg')} width="100%" height="500" padding-bottom="10px" />
    </div>
...
<br></br>
<Button href={'/partiesadmin'}>Political Parties</Button>
<br></br>
<h6>Engagement Links</h6>
<Button href={'/discuss'}>Discussion</Button>
<br></br>
<Button href={'/councillorsadmin'}>Councillors</Button>
<br></br>
<h6>Registration Links</h6>
<Button href={'/faqadmin'}>FAQ</Button>
<br></br>
 </div>
 <br></br>
 </div>

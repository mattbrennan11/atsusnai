...
useEffect(() =>{
  ...
  return (
    <div className="Faq">
      ...
      <NavExample /> 
      <div>
      <h1>Councillors - Causeway Coast & Glens</h1>
      </div>
      <div className="Quiz">
        <br></br>
<div>
...
<Segment inverted>
  ...
  <Form inverted>
    ...
    councillors.map((councillor) => {
      ...
      || councillor.Party.toUpperCase() === userInput) && councillor.Council === "Causeway Coast and Glens"){
      return (
...
export default withAuthenticator(Causeway);

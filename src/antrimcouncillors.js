...
function Antrim({user}) {
  ...
  return (
    <div className="Faq">
      ...
      <NavExample /> 
      <div>
      <h1>Councillors - Antrim & Newtownabbey</h1>
      </div>
      <div className="Quiz">
        <br></br>
<div>
...
<Segment inverted>
  ...
  <Form inverted>
    ...
    councillors.map((councillor) => {
      ...
      || councillor.Party.toUpperCase() === userInput) && councillor.Council === "Antrim and Newtownabbey"){
      return (
...
export default withAuthenticator(Antrim);
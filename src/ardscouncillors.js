...
useEffect(() =>{
  ...
  return (
    <div className="Faq">
      ...
      <NavExample /> 
      <div>
      <h1>Councillors - Ards & North Down</h1>
      </div>
      <div className="Quiz">
        <br></br>
<div>
...
<Segment inverted>
  ...
  <Form inverted>
    ...
    councillors.map((councillor) => {
      ...
      if((councillor.Party == userInput || councillor.Party.toLowerCase() == userInput || councillor.Party.toUpperCase() == userInput) && councillor.Council == "Ards and North Down"){
      return (
...
export default withAuthenticator(Ards);
